...
public class DetalleRecorridoFragment extends Fragment {
    ...
    public static DetalleRecorridoFragment newInstance(String param1, String param2) {
        DetalleRecorridoFragment fragment = new DetalleRecorridoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_detalle_recorrido, container, false);
        ...
        if (objetoRecorrido != null) {
            miRecorrido= (Recorrido) objetoRecorrido.getSerializable("objeto");

            asignarInformacion(miRecorrido);
